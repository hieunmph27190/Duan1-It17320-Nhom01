...
public class ExportFilePdf{
    ...
    public void exportBill(){
        try {
            ...
            table.addCell(new Cell().add("Bill GTeam Store").setTextAlignment(TextAlignment.CENTER)
                    .setVerticalAlignment(VerticalAlignment.MIDDLE)
                    .setMarginTop(30f)
                    .setMarginBottom(30f)
                    .setFontSize(30f)
                    .setBorder(Border.NO_BORDER));
            table.addCell(new Cell().add("GTeam Store"+"\nMã hóa đơn: "+"vinh ăn cứt ngu như bò").setTextAlignment(TextAlignment.RIGHT)
                    .setMarginTop(30f)
                    .setMarginBottom(30f)
                    .setBorder(Border.NO_BORDER)
                    .setMarginRight(20f));
