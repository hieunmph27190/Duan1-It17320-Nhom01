...
//
//            customerInforTable.addCell(new Cell().add("H? tên:").setBorder(Border.NO_BORDER));
...
//            itemTable.addCell(new Cell().add("Tên s?n ph?m").setBackgroundColor(new DeviceRgb(63, 169, 219)).setFontColor(com.itextpdf.kernel.color.Color.WHITE));
...
//            itemTable.addCell(new Cell().add("S? l??ng").setBackgroundColor(new DeviceRgb(63, 169, 219)).setFontColor(com.itextpdf.kernel.color.Color.WHITE));
...
//            itemTable.addCell(new Cell().add("Thành ti?n").setBackgroundColor(new DeviceRgb(63, 169, 219)).setFontColor(com.itextpdf.kernel.color.Color.WHITE));
//            int stt = 0;
//            double tong = 0;
...
//            itemTable.addCell(new Cell().add("").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER));
//            itemTable.addCell(new Cell().add("").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER));
//            itemTable.addCell(new Cell().add("T?ng ti?n").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER).setFontColor(com.itextpdf.kernel.color.Color.WHITE));
...
//            double phaitra = 0;
//            if (rp.xuathoadobbanhang(mhd).size() > 0) {
//                if (rp.xuathoadobbanhang(mhd).get(0).getHoten().equals("khách bán l?")) {
...
//            itemTable.addCell(new Cell().add("Gi?m :" + phantram).setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER).setFontColor(com.itextpdf.kernel.color.Color.WHITE));
//
//            itemTable.addCell(new Cell().add("").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER));
//            itemTable.addCell(new Cell().add("").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER));
//            itemTable.addCell(new Cell().add("").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER));
//            itemTable.addCell(new Cell().add("").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER));
//            itemTable.addCell(new Cell().add("Ti?n ph?i tr? :").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBorder(Border.NO_BORDER).setFontColor(com.itextpdf.kernel.color.Color.WHITE));
...
//    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 500, 340));
